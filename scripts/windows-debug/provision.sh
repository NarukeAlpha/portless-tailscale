...
Log "Installing Bun..."
npm install -g bun
$bunPrefix = (npm prefix -g).Trim()
$env:PATH = "$bunPrefix;$env:PATH"
[Environment]::SetEnvironmentVariable("PATH", "$bunPrefix;$([Environment]::GetEnvironmentVariable('PATH', 'Machine'))", "Machine")
